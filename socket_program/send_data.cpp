...
int main()
{
    ...
    message="helloworld";
    //instead of send write command can also be used to send data across the host
    if(send(socket_des,message,strlen(message),0)<0)
    {
       cout<<"meassage could not be sent"<<endl;
       return 1;
    }
